...
# 'indoor-playground','outdoor-playground', 'helipad', 'roundabout', 'helicopter' , 'individual-container', 'grouped-container' , 'swimming-pool' , 'etc')
    ...
    #            (255, 255, 0), (147, 116, 116), (0, 0, 255), (0, 10, 255), (10, 50, 255), (20, 50, 80),
    #            (150, 110, 20),(65, 200, 5),(175, 210, 20)]
    PALETTE = [(165, 42, 42), (189, 183, 107), (0, 255, 0), (255, 0, 0),
               (138, 43, 226), (255, 128, 0), (255, 0, 255), (0, 255, 255),
               (255, 193, 193), (0, 51, 153), (255, 250, 205), (0, 139, 139),
    ...
    def load_annotations(self, ann_folder):
        """
            Args:
                ann_folder: folder that contains ARIRANG v1 annotations txt files
        """
        cls_map = {c: i
    ...
    def format_results(self, results, submission_dir=None, nproc=4, **kwargs):
        """Format the results to submission text (standard format for ARIRANG
        evaluation).
